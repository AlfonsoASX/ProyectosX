...
//Variables de sesión
	...
	if(!empty($_GET['ordenPrecio']))
	{
		$_SESSION['ordenPrecio']=$_GET['ordenPrecio'];
		$_SESSION['ordenTitulo']='';
		
	}
	if(!empty($_GET['ordenTitulo']))
	{
		$_SESSION['ordenTitulo']=$_GET['ordenTitulo'];
		$_SESSION['ordenPrecio']='';
	
	}
	if(!empty($_GET['operacionInmueble']))
	{
		$_SESSION['operacionInmueble']=$_GET['operacionInmueble'];
	}
	if(!empty($_GET['tipoInmueble']))
	{
		$_SESSION['tipoInmueble']=$_GET['tipoInmueble'];
	}

		$_SESSION['buscar']=$_GET['buscar'];

	
	if(!empty($_POST['precioMenor']))
	{
		$_SESSION['precioMenor']=$_POST['precioMenor'];
	}
	
	if(!empty($_POST['precioMayor']))
	{
		$_SESSION['precioMayor']=$_POST['precioMayor'];
	}

	if($_GET['as']==3&&$_GET['inicio']==1)
	{
  ...
  <tr>
    ...
    <td>
        <p><a class="menuformato" href="?as=1">INICIO</a>
            ...
            <a class="menuformato" href="?as=3&inicio=1">INMUEBLES</a>
...
<!-- AddThis Button END -->    </td>
 ...
 <tr>
    <td height="35" background="img/fodoBuscador.jpg" bgcolor="#EAEAEA"><form id="form1" name="form1" method="get" action="">
        ...
        <div align="right">
          <input name="buscar" type="text" id="buscar" size="50" value="<?php echo $_SESSION["buscar"]; ?>" />
          <input name="as" type="hidden" value="3"  />
          <input type="submit" name="button" id="button" value="Buscar" />
   <?php if(empty($_SESSION['precioMenor'])&&empty($_SESSION['precioMayor']))
	{ ?>       <a href="javascript:AS3Wxmlhttp('ctn/busquedaA.php','buscador');" class="Estilo1">Busqueda avanzada</a><?php } ?></div>
    </form>    <div id="buscador"><?php if((!empty($_SESSION['precioMenor'])||!empty($_SESSION['precioMayor']))&&($_GET['as']==3))
	{ ?><form id="form1" name="form1" method="post" action="?as=3">
  <p align="right"><strong>
    Precio</strong>: Desde:
    <input type="text" value="<?php echo $_SESSION['precioMenor']; ?>" name="precioMenor" id="precioMenor" /> 
    
    Hasta:
    <input type="text" value="<?php echo $_SESSION['precioMayor']; ?>" name="precioMayor" id="precioMayor" />
    <input type="submit" name="x" id="x" value="Buscar" /><a href="?as=3&inicio=1" class="Estilo1">Limpiar b&uacute;squeda</a> </p>
  </form>
  <?php
  }
  ?></div></td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="210" valign="top"><a href="?as=3&amp;operacionInmueble=1&amp;tipoInmueble=<?php echo $_SESSION["tipoInmueble"]; ?>&amp;buscar=<?php echo $_SESSION["buscar"]; ?>"><img src="img/compra2.jpg" width="210" height="37" border="0"/></a> <a href="?as=3&amp;operacionInmueble=2&amp;tipoInmueble=<?php echo $_SESSION["tipoInmueble"]; ?>&amp;buscar=<?php echo $_SESSION["buscar"]; ?>"><img src="img/renta2.jpg" width="210" height="37" vspace="1" border="0"/></a> <a href="?as=4&amp;serv=1"><img src="img/traspaso2.jpg" width="210" height="37" border="0"/></a>
<or esoh2></h2></td>
...
//Algoritmo de búsqueda
	...
	if($_SESSION[operacionInmueble]!="")
	{
		$sql.=" AND operacionInmueble=".$_SESSION[operacionInmueble];
	}
	if($_SESSION[tipoInmueble]!="")
	{
		$sql.=" AND tipoInmueble=".$_SESSION[tipoInmueble];
	}
	...
	if(!empty($_SESSION['ordenPrecio']))
	{
		$ordenar= ' ORDER BY precio '.$_SESSION['ordenPrecio'];
	}
	
	
	if(!empty($_SESSION['ordenTitulo']))
	{
		$ordenar= ' ORDER BY titulo '.$_SESSION['ordenTitulo'];
	}
	
	if(!empty($_SESSION['precioMenor']))
	{
			$sql.=' AND precio >'.$_SESSION['precioMenor'];
	}
	
	if(!empty($_SESSION['precioMayor']))
	{
			$sql.=' AND precio <'.$_SESSION['precioMayor'];
	}
...
{
	$sql.=" AND (
	titulo LIKE '%".$_SESSION['buscar']."%' OR 
	descripcion LIKE '%".$_SESSION['buscar']."%'
	)";
}
$sql.=$ordenar;
...
?>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <a href="?as=3&operacionInmueble=1&tipoInmueble=<?php echo $_SESSION["tipoInmueble"]; ?>&buscar=<?php echo $_SESSION["buscar"]; ?>"><img src="img/compra2.jpg" width="210" height="37" border="0"/></a>
        <a href="?as=3&operacionInmueble=2&tipoInmueble=<?php echo $_SESSION["tipoInmueble"]; ?>&buscar=<?php echo $_SESSION["buscar"]; ?>"><img src="img/renta2.jpg" width="210" height="37" vspace="1" border="0"/></a>
<?php  
$sqlCont="SELECT * FROM  `Inmueble` WHERE status = 1 AND estadoInmobiliaria=0 AND fotoURL!='' ";

if($_SESSION[operacionInmueble]!="")
{
	$sqlCont.=" AND operacionInmueble=".$_SESSION[operacionInmueble];
}

if(!empty($_SESSION['precioMenor']))
{
	$sqlCont.=' AND precio >'.$_SESSION['precioMenor'];
}

if(!empty($_SESSION['precioMayor']))
{
	$sqlCont.=' AND precio <'.$_SESSION['precioMayor'];
}
...
switch($_SESSION[operacionInmueble])
{
	case 1: 
	echo "#CFDFF5";
	break;
 ...
 ?>">
<?php if($contInmuebles[2]!="") { ?><tr <?php if($_SESSION["tipoInmueble"]==2) echo 'bgcolor="#Fc0"'; ?>>
    <td bgcolor="#000000"><a href="?as=3&amp;operacionInmueble=<?php echo $_SESSION["operacionInmueble"]; ?>&amp;tipoInmueble=2&amp;buscar=<?php echo $_SESSION["buscar"]; ?>"><img src="img/casa.png" alt="" border="0" /></a></td>
    <td><div align="center"><a href="?as=3&amp;operacionInmueble=<?php echo $_SESSION["operacionInmueble"]; ?>&amp;tipoInmueble=2&amp;buscar=<?php echo $_SESSION["buscar"]; ?>">Casas</a>(<?php echo $contInmuebles[2]; ?>)</div></td>
    </tr><?php } ?>
<?php if($contInmuebles[4]!="") { ?><tr <?php if($_SESSION["tipoInmueble"]==4) echo 'bgcolor="#Fc0"'; ?>>
    <td bgcolor="#000000"><a href="?as=3&amp;operacionInmueble=<?php echo $_SESSION["operacionInmueble"]; ?>&amp;tipoInmueble=4&amp;buscar=<?php echo $_SESSION["buscar"]; ?>"><img src="img/departamento.png" alt="" border="0" /></a></td>
    <td><div align="center"><a href="?as=3&amp;operacionInmueble=<?php echo $_SESSION["operacionInmueble"]; ?>&amp;tipoInmueble=4&amp;buscar=<?php echo $_SESSION["buscar"]; ?>">Departamentos</a>(<?php echo $contInmuebles[4]; ?>)</div></td>
    </tr><?php } ?>
<?php if($contInmuebles[3]!="") { ?><?php
    if($_SESSION[operacionInmueble]==2) {
        ?><tr <?php if($_SESSION["tipoInmueble"]==3) echo 'bgcolor="#Fc0"'; ?>>
        <td bgcolor="#000000"><a href="?as=3&amp;operacionInmueble=<?php 
        echo $_SESSION["operacionInmueble"]; ?>&amp;tipoInmueble=3&amp;buscar=<?php 
        echo $_SESSION["buscar"]; ?>"><img src="img/cuartos.png" alt="" border="0" /></a></td>
        <td><div align="center"><a href="?as=3&amp;operacionInmueble=<?php 
        echo $_SESSION["operacionInmueble"]; ?>&amp;tipoInmueble=3&amp;buscar=<?php 
        echo $_SESSION["buscar"]; ?>">Cuartos</a>(<?php echo $contInmuebles[3]; ?>)</div></td>
        </tr>
        <?php
    }
    ?><?php } ?>
<?php if($contInmuebles[6]!="") { ?><tr <?php if($_SESSION["tipoInmueble"]==6) echo 'bgcolor="#Fc0"'; ?>>
    <td bgcolor="#000000"><a href="?as=3&amp;operacionInmueble=<?php echo $_SESSION["operacionInmueble"]; ?>&amp;tipoInmueble=6&amp;buscar=<?php echo $_SESSION["buscar"]; ?>"><img src="img/local.png" alt="" border="0" /></a></td>
    <td><div align="center"><a href="?as=3&amp;operacionInmueble=<?php echo $_SESSION["operacionInmueble"]; ?>&amp;tipoInmueble=6&amp;buscar=<?php echo $_SESSION["buscar"]; ?>">Locales</a>(<?php echo $contInmuebles[6]; ?>)</div></td>
    </tr><?php } ?>
<?php if($contInmuebles[7]!="") { ?><tr <?php if($_SESSION["tipoInmueble"]==7) echo 'bgcolor="#Fc0"'; ?>>
    <td bgcolor="#000000"><a href="?as=3&amp;operacionInmueble=<?php echo $_SESSION["operacionInmueble"]; ?>&amp;tipoInmueble=7&amp;buscar=<?php echo $_SESSION["buscar"]; ?>"><img src="img/oficina.png" alt="" border="0" /></a></td>
    <td><div align="center"><a href="?as=3&amp;operacionInmueble=<?php echo $_SESSION["operacionInmueble"]; ?>&amp;tipoInmueble=7&amp;buscar=<?php echo $_SESSION["buscar"]; ?>">Oficinas</a>(<?php echo $contInmuebles[7]; ?>)</div></td>
    </tr><?php } ?>
<?php if($contInmuebles[1]!="") { ?><tr <?php if($_SESSION["tipoInmueble"]==1) echo 'bgcolor="#fc0"'; ?>>
    <td width="50" bgcolor="#000000"><a href="?as=3&amp;operacionInmueble=<?php echo $_SESSION["operacionInmueble"]; ?>&amp;tipoInmueble=1&buscar=<?php echo $_SESSION["buscar"]; ?>"><img src="img/bodega.png" width="48" height="48" border="0" /></a></td>
    <td><div align="center"><a href="?as=3&amp;operacionInmueble=<?php echo $_SESSION["operacionInmueble"]; ?>&amp;tipoInmueble=1&amp;buscar=<?php echo $_SESSION["buscar"]; ?>">Bodegas</a>(<?php echo $contInmuebles[1]; ?>)</div></td>
    </tr><?php } ?>
<?php if($contInmuebles[8]!="") { ?><tr <?php if($_SESSION["tipoInmueble"]==8) echo 'bgcolor="#Fc0"'; ?>>
    <td bgcolor="#000000"><a href="?as=3&amp;operacionInmueble=<?php echo $_SESSION["operacionInmueble"]; ?>&amp;tipoInmueble=8&amp;buscar=<?php echo $_SESSION["buscar"]; ?>"><img src="img/terreno.png" alt="" border="0" /></a></td>
    <td><div align="center"><a href="?as=3&amp;operacionInmueble=<?php echo $_SESSION["operacionInmueble"]; ?>&amp;tipoInmueble=8&amp;buscar=<?php echo $_SESSION["buscar"]; ?>">Terrenos</a> (<?php echo $contInmuebles[8]; ?>)</div></td>
    </tr><?php } ?>
<?php if($contInmuebles[5]!="") { ?><tr <?php if($_SESSION["tipoInmueble"]==5) echo 'bgcolor="#Fc0"'; ?>>
    <td bgcolor="#000000"><a href="?as=3&amp;operacionInmueble=<?php echo $_SESSION["operacionInmueble"]; ?>&amp;tipoInmueble=5&amp;buscar=<?php echo $_SESSION["buscar"]; ?>"><img src="img/edificio.png" alt="" border="0" /></a></td>
    <td><div align="center"><a href="?as=3&amp;operacionInmueble=<?php echo $_SESSION["operacionInmueble"]; ?>&amp;tipoInmueble=5&amp;buscar=<?php echo $_SESSION["buscar"]; ?>">Edificios</a> (<?php echo $contInmuebles[5]; ?>)</div></td>
    </tr><?php } ?>
<?php if($contInmuebles[9]!="") { ?><tr <?php if($_SESSION["tipoInmueble"]==9) echo 'bgcolor="#Fc0"'; ?>>
    <td bgcolor="#000000"><a href="?as=3&operacionInmueble=<?php echo $_SESSION["operacionInmueble"]; ?>&amp;tipoInmueble=9&amp;buscar=<?php echo $_SESSION["buscar"]; ?>"><img src="img/terreno.png" alt="" border="0" /></a></td>
    <td><div align="center"><a href="?as=3&amp;operacionInmueble=<?php echo $_SESSION["operacionInmueble"]; ?>&amp;tipoInmueble=9&amp;buscar=<?php echo $_SESSION["buscar"]; ?>">Ranchos y granjas (<?php echo $contInmuebles[9]; ?>)</a></div></td>
    </tr><?php } ?>
</table>
</td>
        <td valign="top"><div align="left" style="font-size:16px; margin:5px;"> Buscando <b style="font-size:16px">
          <?php 
		switch($_SESSION[tipoInmueble])
		{
			case 1:
			echo "bodegas";
			break;
        ...
        <div align="right">
          <?php if($marca==0) { ?><table border="0" cellspacing="0" cellpadding="5">
            <tr>
              ...
              <td>
<span class="filtro1">
<a href="?as=3&ordenPrecio=<?php if($_SESSION['ordenPrecio']=='ASC') echo 'DESC'; else echo 'ASC';  ?>">Precio</a></span>
<span class="filtro1">
<a href="?as=3&ordenTitulo=<?php if($_SESSION['ordenTitulo']=='ASC') echo 'DESC'; else echo 'ASC';  ?>">Colonia</a></span>
              </td>
            </tr>
          </table><?php } ?>
          </div>
...
<a href="?as=4"><img src="img/traspaso.jpg" width="245" height="87" border="0"/></a></td>
	...
	break;
	 ...
	 ?>">   
    <div align="center">
    <div class="botonTipoInmueble"><a href="?as=3&operacionInmueble=<?php echo $_SESSION["operacionInmueble"]; ?>&tipoInmueble=1"><img src="img/bodega.png" width="48" height="48" vspace="10" /><br />
      Bodegas</a></div>
    <div class="botonTipoInmueble"><a href="?as=3&operacionInmueble=<?php echo $_SESSION["operacionInmueble"]; ?>&tipoInmueble=2"><img src="img/casa.png" vspace="10" /><br />Casas</a></div><?php if($_SESSION[operacionInmueble]==2) { ?>
    <div class="botonTipoInmueble"><a href="?as=3&operacionInmueble=<?php echo $_SESSION["operacionInmueble"]; ?>&tipoInmueble=3"><img src="img/cuartos.png" vspace="10" /><br />Cuartos</a></div><?php } ?>
    <div class="botonTipoInmueble"><a href="?as=3&operacionInmueble=<?php echo $_SESSION["operacionInmueble"]; ?>&tipoInmueble=4"><img src="img/departamento.png" vspace="10" /><br />Departamentos</a></div>
    <div class="botonTipoInmueble"><a href="?as=3&operacionInmueble=<?php echo $_SESSION["operacionInmueble"]; ?>&tipoInmueble=5"><img src="img/edificio.png" vspace="10" /><br />Edificios</a></div>
    <div class="botonTipoInmueble"><a href="?as=3&operacionInmueble=<?php echo $_SESSION["operacionInmueble"]; ?>&tipoInmueble=6"><img src="img/local.png" vspace="10" /><br />Locales</a></div>
    <div class="botonTipoInmueble"><a href="?as=3&operacionInmueble=<?php echo $_SESSION["operacionInmueble"]; ?>&tipoInmueble=7"><img src="img/oficina.png" vspace="10" /><br />Oficinas</a></div>
    <div class="botonTipoInmueble"><a href="?as=3&operacionInmueble=<?php echo $_SESSION["operacionInmueble"]; ?>&tipoInmueble=8"><img src="img/terreno.png" vspace="10" /><br />Terrenos</a></div>
    <div class="botonTipoInmueble"><a href="?as=3&operacionInmueble=<?php echo $_SESSION["operacionInmueble"]; ?>&tipoInmueble=9"><img src="img/terreno.png" vspace="10" /><br />Ranchos y granjas</a></div>
    </div>    </td>
  </tr>
</table><?php 
} 
